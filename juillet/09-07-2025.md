...
- Création d'un nouveau endpoint pour le filtre sur `isAvailable`
	
- Infinite scroll `Links`
	
- Suppression automatique des `MailRequest` après `X` jours
...
- Rappel feature restantes `SpeedDating` : 
	- Guard
	- Keycloak
---
